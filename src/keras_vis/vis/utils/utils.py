...
def draw_text(img, text, position=(10, 10), font=ImageFont.load_default(), font_size=14, color=(0, 0, 0)):
    ...
    Args:
        ...
        font: The ttf or open type font to use. (Default value = ImageFont.load_default())
